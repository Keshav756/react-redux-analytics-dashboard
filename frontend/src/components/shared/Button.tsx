...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    ...
    secondary: 'btn-secondary bg-secondary-200 text-secondary-900 hover:bg-secondary-300 focus:ring-secondary-500',
    success: 'btn-success bg-success-600 text-white hover:bg-success-700 focus:ring-success-500',
    danger: 'btn-danger bg-danger-600 text-white hover:bg-danger-700 focus:ring-danger-500',
  };
